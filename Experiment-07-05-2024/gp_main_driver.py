...
experiment_dict = {'Test Function':[],
                   ...
                   'MAPE':[],
                   'Max Residual Error':[]}  #dictionary is a "3-d" array indexing experiments and outcomes
...
for k, func in enumerate(func_list):  #each learning problem
    for n in numbers_samples: #each number of samples
        ...
        for i, modelclass in enumerate(model_list):
            ...
            r_squared_score, mape, max_res_error = gp_utility_functions.single_instance_model_testing(modelclass,modelname,test_input,test_output)
